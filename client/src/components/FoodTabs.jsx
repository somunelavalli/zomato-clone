          ...
          <Link to={`/${items.id}`} className="w-1/4">
            ...
            >
              <div
                className={
                  type === items.id
                    ? " w-full flex flex-col items-center justify-center py-3 border-t-2 border-zomato-400"
                    : "flex flex-col items-center justify-center py-3 border-t-2 border-white"
                }
              >
                {items.icon}
